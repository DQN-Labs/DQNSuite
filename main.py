...
algo_var = ctk.CTkComboBox(training_frame, values=["PPO", "DQN", "A2C"], state="readonly")
algo_var.set("PPO")
...
dev_info_label = ctk.CTkLabel(about_frame, text="Developed by DQN Labs, May 27, 2024. Version 0.2")
...
doc_text = ctk.CTkLabel(doc_frame, text="Welcome to the DQNSuite! Before you embark on your journey, I highly suggest you go through this documentation page.", wraplength=600)
